            ...
            {leaderboardData.length >= 3 && (
              <div className="flex justify-center items-end h-64 gap-2 md:gap-4 px-4 py-8 bg-gradient-to-t from-background/50 to-transparent rounded-t-xl">
                ...
                >
                  ...
                  <div className="text-xs text-accent font-bold mb-2">{leaderboardData[1].profit} {leaderboardData[1].currency || 'SOL'}</div>
                ...
                >
                  ...
                  <div className="text-sm text-accent font-bold mb-2">{leaderboardData[0].profit} {leaderboardData[0].currency || 'SOL'}</div>
                ...
                >
                  ...
                  <div className="text-xs text-accent font-bold mb-2">{leaderboardData[2].profit} {leaderboardData[2].currency || 'SOL'}</div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="text-right py-4 px-6">
                        <div className="font-bold text-accent">{entry.profit} {entry.currency || 'SOL'}</div>
                      </td>
                      <td className="text-right py-4 px-6">
