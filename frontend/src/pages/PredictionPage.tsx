      ...
      <div className="glass-card p-8 relative overflow-hidden">
        ...
        <div className="absolute top-4 right-4">
          <button
            ...
            className="bg-white/10 hover:bg-white/20 text-text font-bold py-2 px-3 rounded-lg border border-white/10 transition-all flex items-center space-x-2 text-sm"
          >
